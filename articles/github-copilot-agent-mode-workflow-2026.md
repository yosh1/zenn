...
<!-- TODO: スクショ — VS Code チャットパネルで Agent モードを選択している画面 -->
...
<!-- TODO: スクショ — /plan の出力例（設計図が表示されている画面） -->
...
<!-- TODO: スクショ — /fleet の実行画面（複数タスクが並列で走っている様子） -->
...
<!-- TODO: スクショ — Issue の Assignees に Copilot を追加している画面 -->
...
<!-- TODO: スクショ — Coding Agent が生成したドラフト PR の画面 -->
...
<!-- TODO: スクショ — VS Code でモデルを切り替えているドロップダウン -->
